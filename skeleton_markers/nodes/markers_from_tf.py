...
## from skeleton_markers import interceptor as interceptor_msgs
import tf
...
class SkeletonMarkers():
    def __init__(self):
        ...
        ## skeleton_pub = rospy.Publisher('skeleton_pub', interceptor_msgs, queue_size = 5)
        ...
        while not rospy.is_shutdown():
            ...
            ## skeleton_pub.publish(self.markers)
